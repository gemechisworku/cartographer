...
def main() -> None:
    # Load .env from current directory (or project root) so OPENAI_API_KEY etc. are available
    load_dotenv()
    ...
    # Suppress noisy HTTP request logs from OpenAI/httpx; keep Cartographer's own logs
